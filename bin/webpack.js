...
const localInstallation = resolveCWD.silent('webpack-cli/bin/webpack');
// Prefer the local installation of webpack-cli
console.log(require.resolve('webpack'))
if (localInstallation && localInstallation !== __filename) {
  require(localInstallation);
  console.log(localInstallation)
}
